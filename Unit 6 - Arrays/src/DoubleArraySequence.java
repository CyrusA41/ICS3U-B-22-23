...
public class DoubleArraySequence implements Cloneable {
    ...
    public void addAll(DoubleArraySequence addend) {
      ...
      if(addSize+manyItems>data.length)
         ensureCapacity(addSize+manyItems);
    ...
    public void advance() {
      if(!isCurrent())
         throw new IllegalStateException("There is no current element, therefore the method could not be called.");
      else
         currentIndex++;
    }
